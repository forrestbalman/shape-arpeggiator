...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 429.0, 162.0, 92.708333333333371, 22.0 ],
					"text" : "note $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 334.0, 162.0, 92.708333333333371, 22.0 ],
					"text" : "note $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 239.0, 162.0, 92.708333333333371, 22.0 ],
					"text" : "note $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 144.0, 162.0, 92.708333333333371, 22.0 ],
					"text" : "note $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 49.0, 162.0, 92.708333333333371, 22.0 ],
					"text" : "note $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 515.0, 383.0, 81.0, 22.0 ],
					"text" : "loadmess -24"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 49.0, 435.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 49.0, 383.0, 455.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "", "", "", "", "", "" ],
					"patching_rect" : [ 49.0, 69.0, 494.0, 22.0 ],
					"text" : "route /origin /north /east /south /west"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 49.0, 16.0, 104.0, 22.0 ],
					"text" : "udpreceive 41236"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 438.5, 312.0, 58.5, 312.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-60", 0 ],
					"midpoints" : [ 153.5, 312.0, 58.5, 312.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-60", 0 ],
					"midpoints" : [ 248.5, 312.0, 58.5, 312.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-60", 0 ],
					"midpoints" : [ 524.5, 416.0, 508.0, 416.0, 508.0, 368.0, 58.5, 368.0 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 58.5, 432.0, 84.5, 432.0 ],
					"order" : 0,
					"source" : [ "obj-60", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-60", 0 ],
					"midpoints" : [ 343.5, 312.0, 58.5, 312.0 ],
					"source" : [ "obj-7", 0 ]
				}
